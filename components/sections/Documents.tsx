...
export function Documents() {
  ...
  return (
    <section id="documents" className="px-2 sm:px-4">
      <div className="rounded-[32px] bg-sage-light py-20 sm:rounded-[48px] sm:py-28">
        <div className="container-x">
          ...
          <Reveal delay={100}>
            <article className="relative mx-auto mt-12 max-w-4xl overflow-hidden rounded-[32px] border border-sage bg-white p-8 shadow-card transition-shadow duration-300 hover:shadow-card-hover sm:p-12">
              <Circle className="absolute -top-12 -right-12 h-40 w-40 bg-brand-soft" />
              <Sparkle className="absolute top-8 right-10 h-6 w-6 text-leaf" />
